...
const styles ={
  ...
  nav: `flex justify-between items-center gap-[20px]  h-full max-w-screen-xl mx-auto`,
  header: `bg-[#17171A] text-white h-20 flex gap-[100px] w-full p-[30px]`,
  headerWrapper: `flex justify-between items-center h-full max-w-screen-xl mx-auto px-4`,
